...
to a direct comparison of stash pointers. That is,
    ...
    ref Types::Bool::true eq Types::Bool::BOOL_PACKAGE

is equivalent to

    ref Types::Bool::true eq 'JSON::PP::Boolean'
...
or false value by using
    ...
    Types::Bool::BOOL_PACKAGE->new($value);
...
=head2 new
    ...
    $bool = Types::Bool::BOOL_PACKAGE->new($value);
